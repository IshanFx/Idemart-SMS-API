...
class SmsSender{
    ...
    **/
    ...
    public function sms($message, $addresses, $password, $applicationId, $encoding, $version){
        if (is_array($addresses)) {
            return $this->smsMany($message, $addresses, $password, $applicationId, $encoding, $version);
        } else if (is_string($addresses) && trim($addresses) != "") {
            return $this->smsMany($message, array($addresses), $password, $applicationId, $encoding, $version);
        } else {
    ...
    **/
    ...
    private function smsMany($message, $addresses, $password, $applicationId, $encoding, $version){
